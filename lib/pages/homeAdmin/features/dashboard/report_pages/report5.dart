...
class Report5 extends StatefulWidget {
  ...
  @override
  _Report5State createState() => _Report5State();
}
...
final pizzaProducts = await FirebaseFirestore.instance
  ...
  if (count > 0) { 
    ...
    print('Producto con conteo cero: $productKey'); // Agregar esto para depuración
  }
...
void main() {
  runApp(const MaterialApp(home: Report5()));
}
